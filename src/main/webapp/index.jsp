...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h1 class="text-center">My job is done with jenkinsit is very easy</h1>
      <h2 class="text-center">Welcome to Chandan, Abhilash, Som, Shubam , Pragithi and  Shruthi on behalf of DevOps Academy</h2>
